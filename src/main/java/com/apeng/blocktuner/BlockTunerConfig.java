...
public class BlockTunerConfig {
    ...
    private static final Path CONFIG_PATH = Path.of(FMLConfig.defaultConfigPath(), "blocktuner.properties");
    ...
    // This field is always ture to be compatible with Forge API
    public static boolean onBlockTunerServer = true;
